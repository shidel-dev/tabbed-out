...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var smenu = document.getElementById('setmenu');
...
document.getElementById("setmenu").insertAdjacentHTML('beforeend', '<span id="land" ></span>');
        ...
        for (var i = master.length - 1; i >= 0; i--) {
            ...
            document.getElementById("land").insertAdjacentHTML('beforeend', '<div class="gendiv" id="' + i + '"  >'+master[i][0]+'<img id="' + i + '" src="closeButton.png" class="close"/> </div>');
         

        }
 for (var i = master.length - 1; i >= 0; i--) {
  document.getElementsByClassName('gendiv')[i].addEventListener('click',direct);
}
});
    ...
    for (var i = 0; i < 2; i++) {
        arrows[i].addEventListener('click', aclick);
    }
